...
class EditField extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      temptype:this.props.field.name
    };
  ...
  render() {
    ...
    if((this.state.temptype)=="appln_no")
    {
      this.state.temptype="date"
    }else
    {
      this.state.temptype="text"
    }
      ...
      return (
        <div>
          <div className="table-responsive">
            ...
            <br/>
            <FullWidthButton buttontext={"Add Child"} onClick={this.handleAddClick} />
        </div>
       </div>
      );
    }
...
var data = {
  ...
  "instances": [{
    ...
    "date_modified": "Mylapur",
    "filing_date": "Karatagi",
    "id": 1,
    "pub_date":"karnataka",
   // "pub_no": null
  ...
  export default class ChildProfile extends React.Component {
    render() {
      return (
        <TableContainer title="Children Information" data={data}/>
         );
    }
  }